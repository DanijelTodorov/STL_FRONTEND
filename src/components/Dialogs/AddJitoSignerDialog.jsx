...
export default function AddJitoSignerDialog({ isOpen, onOK, onClose }) {
            ...
            <div className="flex flex-col pt-5 w-[512px]">
                ...
                <div className="w-full h-auto px-5 py-5 md:py-0 bg-slate-900 bg-opacity-90  rounded-b-[8px] items-center">
                    <div className="mt-3">
                        ...
                        <input type="password"
                            className="w-full h-[40px] rounded-[6px] bg-[rgba(255,255,255,0.1)] px-[15px] text-white outline-none focus:border focus:border-baseColor" placeholder="Enter Private Key"
                            value={privateKey}
